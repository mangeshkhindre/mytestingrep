...
arrDatesBorrower1 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair1,"Initial","LE",arrInitialLESentDates(0),"","","No")
...
'FRM_Logger_ReportStepEvent "Validate LE Received Date for 1st Borrower Pair ", "Validate LE Received for 1st Borrower Pair when No Received Dates are Entered", null
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates for LE for 1st Borrower Pair", "Validate ECD for 1st Borrower Pair when no Received Dates are entered", null
'FRM_Logger_ReportStepEvent "Validate LE Sent Date for 1st Borrower Pair", "Validate LESent Date for 1st Borrower Pair when no Received Dates are entered", null
...
arrDatesBorrower2 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair2,"Initial","LE",arrInitialLESentDates(1),"","","No")
...
'FRM_Logger_ReportStepEvent "Validate LE Received Date when 2nd Borrower Pair is Eneterd", "Validate LE Received when No Received Dates are Entered", null
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates when 2nd Borrower Pair is Entered", "Validate ECD when no Received Dates are entered", null
'FRM_Logger_ReportStepEvent "Validate LE Sent Date when 2nd Borrower Pair is Entered", "Validate LESent Date when no Received Dates are entered", null
...
arrDatesBorrower3 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Initial","LE",arrInitialLESentDates(2),"","","No")
...
'FRM_Logger_ReportStepEvent "Validate Earliest Closing  Dates for LE when 3rd Borrower Pair is Entered", "Validate for Initial LE when no Received Dates are entered", null
...
'FRM_Logger_ReportStepEvent "Validate LE Received Date when 3rd Borrower Pair is Entered", "Validate LE Received when No Received Dates are Entered", null
     
dtEarliestDate=BIZ_GetEarliestDate(arrAllDates)
BIZ_DisclosureTracking_ValidateLEReceived dtEarliestDate,"Initial"
'FRM_Logger_ReportStepEvent "Validate LE Sent Date when 3rd Borrower Pair is Entered", "Validate LESent Date when no Received Dates are entered", null
...
arrDatesBorrower1 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair1,"Initial","LE",arrInitialLESentDates(0),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")
...
arrDatesBorrower2 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair2,"Initial","LE",arrInitialLESentDates(1),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")
'=========Validate LE Sent, LE Received, ECD for 2nd borrower pair===================
'FRM_Logger_ReportStepEvent "Validate LE Received Date when 2nd Borrower Pair is Eneterd", "Validate LE Received when  Received Dates are Entered", null
'sent
arrInitialLESentDates(1)=BIZ_DisclosureTracking_DateCalculation(DateAdd("d",-43,Date),1,"Reg_ZBusinessCalender")
 arrInitialLESentDates(2)=BIZ_DisclosureTracking_DateCalculation(DateAdd("d",-44,Date),1,"Reg_ZBusinessCalender")
 BIZ_DisclosureTracking_ValidateLESent arrInitialLESentDates,"Initial"
...
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates when 2nd Borrower Pair is Entered", "Validate ECD when Received Dates are entered", null
'FRM_Logger_ReportStepEvent "Validate LE Sent Date when 2nd Borrower Pair is Entered", "Validate LESent Date when Received Dates are entered", null
...
arrDatesBorrower3 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Initial","LE",arrInitialLESentDates(2),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")
...
'FRM_Logger_ReportStepEvent "Validate LE Received Date when 3rd Borrower Pair is Entered", "Validate LE Received when Actual Received Dates are Entered", null
  'ecd
...
'FRM_Logger_ReportStepEvent "Validate LE Sent Date when 3rd Borrower Pair is Entered", "Validate LE Sent Date when Received Dates are entered", null
  
'FRM_Logger_ReportStepEvent "Validate Earliest Closing  Dates for LE when 3rd Borrower Pair is Entered", "Validate for Initial LE when Received Dates are entered", null
...
BIZ_DisclosureTracking_MultipleBorrPair_AddDisclosure strBorrPair1,"LE"
arrDatesBorrower1 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair1,"Revised","LE",arrRevisedLESentDates(0),"","","Yes")
...
BIZ_DisclosureTracking_MultipleBorrPair_AddDisclosure strBorrPair2,"LE"
arrDatesBorrower2 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair2,"Revised","LE",arrRevisedLESentDates(1),"","","Yes")
...
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates for Revised LE when 2nd Borowwer Pair is Entered", "Validate when no Received Dates are entered for Revised LE", null
...
'FRM_Logger_ReportStepEvent "Validate Revised LE Received Date when 2nd Borowwer Pair is Entered", "Validate Revised LE Received when No Received Dates are Entered", null
...
BIZ_DisclosureTracking_MultipleBorrPair_AddDisclosure strBorrPair3,"LE"
arrDatesBorrower3 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Revised","LE",arrRevisedLESentDates(2),"","","Yes")
...
'======Validate LE Sent Date when No Dates are Entered==========
'================Verify LE Sent Date should be earliest of all Sent Dates=================
'FRM_Logger_ReportStepEvent "Validate Revised LE Sent Date for 3rd Borrower Pair", "Verify Revised LE Sent Date for 3rd Borrower Pairwhen No Received Dates are Entered", null
 BIZ_DisclosureTracking_ValidateLESent arrRevisedLESentDates,"Revised"

'=====================Validate ECD in  Revised LE when no Received Dates are entered ======================
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates for Revised LE for 3rd Borrower Pair", "Validate for 3rd Borrower Pair when no Received Dates are entered for Revised LE", null
Set objLoanPage = SwfWindow("swfname:=MainForm").SwfWindow("swfname:=MainScreen").SwfWindow("swfname:=LoanPage")
Set objLESentDate = objLoanPage.SwfObject("swfname:=dpLERevisedSent").SwfEdit("swfname:=txtDate")
dtLESent=GUI_Object_GetPropertyValue (objLESentDate,"text")
...
'=============Validate LE Received Date when No Received Dates are Entered =================
'FRM_Logger_ReportStepEvent "Validate Revised LE Received Date for 3rd Borrower Pair", "Validate Revised LE Received for 3rd Borrower Pair when No Received Dates are Entered", null
dtEarliestDate=BIZ_GetEarliestDate(arrAllDates)
BIZ_DisclosureTracking_ValidateLEReceived dtEarliestDate,"Revised"
...
arrDatesBorrower1 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair1,"Revised","LE",arrRevisedLESentDates(0),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")
...
arrDatesBorrower2 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair2,"Revised","LE",arrRevisedLESentDates(1),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")

'=============Validate Revised LE Received Date when Received Dates are Entered =================
'FRM_Logger_ReportStepEvent "Validate Revised LE Sent Date for LE for 2nd Borrower Pair", "Revised LESent Date for 2nd Borowwer Pair when Received Dates are Entered", null

arrRevisedLESentDates(1)=BIZ_DisclosureTracking_DateCalculation(DateAdd("d",-35,Date),1,"Reg_ZBusinessCalender")
arrRevisedLESentDates(2)=BIZ_DisclosureTracking_DateCalculation(DateAdd("d",-1,Date),1,"Reg_ZBusinessCalender")
BIZ_DisclosureTracking_ValidateLESent arrRevisedLESentDates,"Revised"

'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates for LE for 2nd Borrower Pair", "Validate when Received Dates are entered for Revised LE for 2nd Borrower Pair", null
...
'FRM_Logger_ReportStepEvent "Validate Revised LE Received Date for 2nd Borrower Pair", "Validate Revised LE Received for 2nd Borowwer Pair when Received Dates are Entered", null
dtEarliestDate=BIZ_GetEarliestDate(arrDatesBorrower2)
BIZ_DisclosureTracking_ValidateLEReceived dtEarliestDate,"Revised"
...
arrDatesBorrower3 = BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Revised","LE",arrRevisedLESentDates(2),dtBorrActualRecDate,dtCoBorrActualRecDate,"No")
...
'======Validate LE Sent Date when No Dates are Entered==========
'================Verify LE Sent Date should be earliest of all Sent Dates=================
'FRM_Logger_ReportStepEvent "Validate Revised LE Sent Date for 3rd Borowwer Pair", "Verify Revised LE Sent Date for 3rd Borowwer Pair when Received Dates are Entered", null
 
BIZ_DisclosureTracking_ValidateLESent arrRevisedLESentDates,"Revised"

'=====================Validate ECD in  Revised LE when Received Dates are entered ======================
'FRM_Logger_ReportStepEvent "Validate Earliest Closing Dates for LE for 3rd Borowwer Pair", "Validate for 3rd Borowwer Pair hen Received Dates are entered for Revised LE", null
...
'FRM_Logger_ReportStepEvent "Validate Revised LE Received Date for 3rd Borowwer Pair", "Validate Revised LE Received for 3rd Borowwer Pair when Received Dates are Entered", null
