    ...
    '=========== Create Primary Resc Loan ========    
	RunAction "CreateNewLoan", oneIteration,"Primary"
    
    '=========Intial CD Send - Manual Disclosure and Revised CD - Manual Disclosure ======
    RunAction "SendInitialRevisedCD", oneIteration,"Primary"  
    
    '===============Loan Exit ================
    BIZ_Loan_Exit False
    
    '=========== Create Primary Construction Resc Loan ======== 
	RunAction "CreateNewLoan", oneIteration,"Construction"
    
    '=========Intial CD Send - Manual Disclosure and Revised CD - Manual Disclosure ======    
    RunAction "SendInitialRevisedCD", oneIteration,"Construction"   
