'@**************************************************************************************************
 ...
 '@ Test Automation JIRA Task: CTA-430 Dev Task For TestCase : FHANoCashOutRefi 
...
'LoanType(1172) :Conventional
'Lien Position(420):First
'Amortization type(608):Fixed Rate
'Loan Amount(1109):300,000
'Total Loan Amt:(2): 300,000
'Interest Rate(3):3.5%
'Term(4):360
'Due In(325): 360
'Address(11): 123 Main street
'City(12): Fremont
'State(14):CA
'Zip(15):94536
'County(13):Alameda
'No. units(16):1
'Year Built(18):1999
'Purpose Of loan(19): Cash-Out-Refi
'PropertywillBe(1811):Primary
'Borrower First Name(4000): LCRefinance
'BorrowerLAstName(4002):LCRefinance
...
FRM_Logger_ReportInfoEvent "Start Test Case: Lender Credit", "Script Name - CIBIZ_CTA_430_E2E_FHANoCashOutRefi", Null
...
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Lender Credit TestCase", Null
...
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Open the form 1003 page 1 and Entering the data", Null
BIZ_1003Page1_SetData("FHANoCashOutRefi")
wait(3)

'====== Open the form 1003 page 2 and Entering the data ======
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Open the form 1003 page 2 and Entering the data", Null
...
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Open the form Borrower summary form and Entering the data", Null
BIZ_BorrowerSummaryOrigination_SetProperty "LC_Conventional_Refinance"

'====== Open the form 1003 page 3 and Entering the data ======
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Open the form 1003 page 3 and Entering the data", Null
...
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the value at 202 field as 'Lender Credit'", Null

'Set the value to filed 141 as 1000
GUI_WinEdit_Set objParentObject.Page("url:=.*Encompass.*").WebEdit("title:=141.*"),"1000"
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the value at 101 field as 1000", Null

'Clicking the VOM button to set the liabilities
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Clicking the VOM button to set the liabilities", Null
BIZ_VOM_SetNewLiabilities "LC_Conventional_Refinance"
wait(3)

'====== Open the 2015Itemization form and Entering the data ======
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Open the 2015Itemization form and Entering the data", Null
BIZ_2015Itemization_SetE2EBasicData "LC_Conventional_Refinance"

'setting the value for section 900
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "setting the value for section 900", Null
...
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "setting the value for section 800", Null
...
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the data to field 804", Null
...
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the data to field 805", Null
...
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the data to field 806", Null
...
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Entering the data to field 807", Null

'All Validation started by pagewise
FRM_Logger_ReportInfoEvent "Test Case:FHANoCashOutRefi", "Validation of auto populated data started by pagewise", Null

'Validation on 1003 page
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "First validation started for Form 1003 Page 3", Null
...
Set objData10 = FRM_DS_GetTestData("FiledValidation", "Auto_Populated", "LC_Conventional_Refinance")
...
BoolValue = GUI_ValidateValueOfObject(ObjMarketValue919, FRM_DS_GetValue(objData10, "Field_919"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Market Value(919)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Market Value(919)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjAmountOfMtg920,FRM_DS_GetValue(objData10, "Field_920"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Amount of Mtg(920)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Amount of Mtg(920)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjMtgPaymnt922,FRM_DS_GetValue(objData10, "Field_922"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Mtg Payment(922)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Mtg Payment(922)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjRefinance1092,FRM_DS_GetValue(objData10, "Field_1092"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Refinance(1092)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Refinance(1092)' has  NOT validated", Null	
End If

Set objData3 = FRM_DS_GetTestData("FiledValidation", "Auto_Populated", "FHANoCashOutRefi")
...
BoolValue = GUI_ValidateValueOfObject(ObjPaidby1852,FRM_DS_GetValue(objData3, "Field_1852"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'cc Paid by broker,lender and Other(1852)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'cc Paid by broker,lender and Other(1852)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjTotalCredits1844,FRM_DS_GetValue(objData3, "Field_1844"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Credits(1844)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Credits(1844)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjCashToBrwr,FRM_DS_GetValue(objData3, "Field_142"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Cash To Borrower(142)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Cash To Borrower(142)' has  NOT validated", Null	
End If

'Second Validation on VOM form

'Opening the VOM form
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Second validation started for Form VOM", Null
BIZ_Forms_Open "VOM"
...
BoolValue = GUI_ValidateValueOfObject(ObjCityFM0106,FRM_DS_GetValue(objData10, "FM0106"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Address(FM0106)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Address(FM0106)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjPrsntValuMrktValueFM0119,FRM_DS_GetValue(objData10, "FM0119"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Present Market Value(FM0119)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Present Market Value(FM0119)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjMrtgBlncFM0117,FRM_DS_GetValue(objData10, "FM0117"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Mortagage Balance(FM0117)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Mortagage Balance(FM0117)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjMrtgPymntFM0116,FRM_DS_GetValue(objData10, "FM0116"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Mortagage Payment(FM0116)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Mortagage Payment(FM0116)' has  NOT validated", Null	
End If

'Opening the 2015 Itemization form for validation

FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Third validation started for Form 2015 Itemization", Null
...
BoolValue = GUI_ValidateValueOfObject(ObjTotalLenderPaidCC_LENPC,FRM_DS_GetValue(objData10, "LENPCC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Lender Paid CC(LENPCC)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Lender Paid CC(LENPCC)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjotalOthrPaidCC_OTHPCC,FRM_DS_GetValue(objData10, "OTHPCC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Other Paid CC(OTHPCC)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Other Paid CC(OTHPCC)' has  NOT validated", Null	
End If
...
BoolValue = GUI_ValidateValueOfObject(ObjTotalNonBrwrPaidCC_TNBPCC,FRM_DS_GetValue(objData10, "TNBPCC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Non-borrower Paid CC(b)(TNBPCC)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Non-borrower Paid CC(b)(TNBPCC)' has  NOT validated", Null	
End If

Set objData4 = FRM_DS_GetTestData("FiledValidation", "Auto_Populated", "FHANoCashOutRefi")
...
BoolValue = GUI_ValidateValueOfObject(ObjTotalLndrCerdit_NEWHUD_X1149,FRM_DS_GetValue(objData4, "NEWHUD.X1149"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Lender Cerdit©(NEWHUD.X1149)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Lender Cerdit©(NEWHUD.X1149)' has  NOT validated", Null	
End If

Set objData5 = FRM_DS_GetTestData("FiledValidation", "Auto_Populated", "FHANoCashOutRefi")
...
BoolValue = GUI_ValidateValueOfObject(ObjTotlClsingCst_TOTPCC,FRM_DS_GetValue(objData5, "TOTPCC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Closing Cost(a+b)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Closing Cost(a+b)' has  NOT validated", Null	
End If

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Total Costs(1073)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Total Costs(1073)' has  NOT validated", Null	
End If
Set objData6 = FRM_DS_GetTestData("FiledValidation", "Auto_Populated", "FHANoCashOutRefi")
'Object of field "cc Paid by broker,lender and Other(1852)" and value should display 2550(Should be autopopulated)
Set ObjPaidby1852= SwfWindow("swfname:=MainForm").Page("index:=0").WebEdit("html id:=l_1852")

BoolValue = GUI_ValidateValueOfObject(ObjPaidby1852,FRM_DS_GetValue(objData6, "Field_1852"))
...
BoolValue = GUI_ValidateValueOfObject(ObjTotalCredits1844,FRM_DS_GetValue(objData6, "Field_1844"))
...
BoolValue = GUI_ValidateValueOfObject(ObjCashToBrwr,FRM_DS_GetValue(objData6, "Field_142"))
...
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Fourth validation started for Form Closing Disclosure Page 1", Null
...
BoolValue = GUI_ValidateValueOfObject(ObjLenderCredits_CD2_XSTLC,FRM_DS_GetValue(objData6, "CD2.XSTLC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Lender Credits(CD2.XSTLC)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Lender Credits(CD2.XSTLC)' has  NOT validated", Null	
End If

'Open the Loan Disclosure 1 for validation

BIZ_Forms_Open "Loan Estimate Page 1"
FRM_Logger_ReportStepEvent "Test Case:FHANoCashOutRefi", "Fifth validation started for Form Loan Disclosure 1", Null
...
BoolValue = GUI_ValidateValueOfObject(ObjLenderCredits_LE2_XLC,FRM_DS_GetValue(objData6, "LE2.XLSC"))

'Below code is to verify the compariosn of Actual and Expected value and log the same in report
If BoolValue Then
FRM_Logger_ReportPassEvent "Test Case:FHANoCashOutRefi", "Field 'Lender credits(LE2.XLC)' has been validated successfully", Null
Else
FRM_Logger_ReportFailEvent "Test Case:FHANoCashOutRefi", "Field 'Lender credits(LE2.XLC)' has  NOT validated", Null	
End If
