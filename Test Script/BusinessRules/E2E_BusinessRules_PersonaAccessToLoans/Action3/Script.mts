...
'
FRM_Logger_ReportStepEvent "Test step-5","Activate business rule "&strRowID,NULL
...
FRM_Logger_ReportStepEvent "Test step-6","Create new loan.",NULL

'=====================Select Pipeline View and Create a new blank loan====================
BIZ_Loan_AddNewBlankLoanUnderSelectedLoanFolder "", "Automation"

FRM_Logger_ReportStepEvent "Test step-7","Input data in field which will trigger rule "&strRowID,NULL
...
FRM_Logger_ReportStepEvent "Test step-8","Validate if business rule "&strRowID&" is triggered.",NULL
...
'BIZ_BR_PersonaAccestoLoan_Select strRowID,"Single"
'
'FRM_Logger_ReportStepEvent "Test step-9","Import the business rule "&strRowID,NULL
'
...
'
'FRM_Logger_ReportStepEvent "Test step-10","Verify business rule "&strRowID&" is imported successfully.If not then try again.",NULL
'
...
'boolIsFound = GUI_List_ClickRow(objAccessToLoanRuleEntryList, NULL, "Name", strRowID, True, False, False, "Single")
'
'FRM_Logger_ReportStepEvent "Test step-10","Verify business rule "&strRowID&" is imported successfully.",NULL
'
''===============Check if rule is imported successfully=================
'If boolIsFound Then
'	FRM_Logger_ReportPassEvent "Import Business Rule","Business Rule is imported successfully.",NULL
...
'BIZ_Login_UserLogin "e2ebrpal"
'
'FRM_Logger_ReportStepEvent "Test step-11","Create new loan.",NULL
'
''=====================Select Pipeline View and Create a new blank loan====================
'BIZ_Loan_AddNewBlankLoanUnderSelectedLoanFolder "", "My Pipeline"
'
'FRM_Logger_ReportStepEvent "Test step-12","Input data in field which will trigger rule "&strRowID,NULL
'
''==Go to Borrower Summary - Origination================
'BIZ_Forms_Open "Borrower Summary - Origination"
'
...
'BIZ_Loan_OpenLoanByColFieldValue "Loan Number",strLoanNumber
'
'FRM_Logger_ReportStepEvent "Test step-13","Validate if business rule "&strRowID&" is triggered.",NULL
'
''===============Validate the business rule condition====================
'ValidateBusinessRuleCondition()
'
