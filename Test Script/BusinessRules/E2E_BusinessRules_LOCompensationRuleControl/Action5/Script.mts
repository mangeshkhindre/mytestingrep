...
'@ TestCase: PTAC-1433  Display warning when all compensation fields are not compliant Set fields OFF
...
'@ Pre-conditions:
'@ Description: Display warning when all compensation fields are not compliant Set fields OFF
'@ TestSteps:
...
'***************************************************************************************************
	Set objData = FRM_DS_GetTestData("BusinessRule_LOCompensation", "LOCompensationData", "BR_LoCompensationDisplayWarning")
	ExecutionFlag = FRM_DS_GetValue(objData, "ExecutionFlag")
	If ExecutionFlag = "Y" Then
	
	FRM_Logger_ReportStepEvent "Start Test Case :PTAC-1433 ","TestCase Name -  Display warning when all compensation fields are not compliant Set fields OFF", Null
	...
	BR_LOCompensationRule "BR_LoCompensationDisplayWarning"
	...
	'====== Sets the value in 2015 Itemization with Paid To ======
