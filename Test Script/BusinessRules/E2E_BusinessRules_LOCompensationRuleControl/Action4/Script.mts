...
'@ TestCase:  PTAC-1434  Do not enforce compliance or display a warning
...
'***************************************************************************************************
	Set objData = FRM_DS_GetTestData("BusinessRule_LOCompensation", "LOCompensationData", "BR_LoCompensation")
	ExecutionFlag = FRM_DS_GetValue(objData, "ExecutionFlag")
	If ExecutionFlag = "Y" Then
	
	FRM_Logger_ReportStepEvent "Start Test Case :PTAC-1434 ","TestCase Name - Do not enforce compliance or display a warning", Null
	...
	'====== Verify whether Green Dollar icon is visible or not ======
