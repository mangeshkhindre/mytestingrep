...
'@ TestCase:  PTAC-1562 Verify Appraisal Order with Loan type as 'USDA_RHS'
'@ Test Automation JIRA Task: PTAC-1850 BusinessRules_AppraisalOrderLoanTypeAsUSDA_RHS
'@ TestData: 
...
'@ TestSteps:
   '1 Login to Encompass with Admin user
      ...
      'select loan Type as 'USDA_RHS',select Ordering Optional as 'Approved Appraisers Only' and select 'Loan Officer' Persona and check 'Enable Ordering' check box
...
Set objData = FRM_DS_GetTestData("BusinessRule_PersonaAccessToFields", "AppraiserOrderDetails", "PTAC-1562")
strExecutionFlag = FRM_DS_GetValue(objData, "ExecutionFlag")
If strExecutionFlag = "Y" Then
	
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-1562","Verify Appraisal Order with Loan type as 'USDA_RHS'", Null
...
BR_AdminUser_ChangeSettings "PTAC-1562"
...
strLoanNumber = BR_CreateLoanWithBorrowerSummaryOriginationInfo("PTAC-1562")
Wait g_ShortWaitMedium + g_ShortWaitMedium 'Due To Sync Issue We Are Explicitly Passing Wait Statement
BR_OrderAppraisal_NonAdmin "PTAC-1562",strLoanNumber
BIZ_Loan_Exit(False)
