...
'@ TestCase:  PTAC-1563 Verify Appraisal Order with Loan type as 'Other'
'@ Test Automation JIRA Task: PTAC-1851 BusinessRules_AppraisalOrderLoanTypeAsOther
'@ TestData: 
...
'@ TestSteps:
   '1 Login to Encompass with Admin user
      ...
      'select loan Type as 'Other',select Ordering Optional as 'Approved Appraisers Only' and select 'Loan Officer' Persona and check 'Enable Ordering' check box
...
'***************************************************************************************************
Set objData = FRM_DS_GetTestData("BusinessRule_PersonaAccessToFields", "AppraiserOrderDetails", "PTAC-1563")
strExecutionFlag = FRM_DS_GetValue(objData, "ExecutionFlag")
If strExecutionFlag = "Y" Then
	
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-1563","Verify Appraisal Order with Loan type as 'Other'", Null
...
BR_AdminUser_ChangeSettings "PTAC-1563"
...
strLoanNumber = BR_CreateLoanWithBorrowerSummaryOriginationInfo("PTAC-1563")
Wait g_ShortWaitMedium + g_ShortWaitMedium 'Due To Sync Issue We Are Explicitly Passing Wait Statement
BR_OrderAppraisal_NonAdmin "PTAC-1563",strLoanNumber
BIZ_Loan_Exit(False)
