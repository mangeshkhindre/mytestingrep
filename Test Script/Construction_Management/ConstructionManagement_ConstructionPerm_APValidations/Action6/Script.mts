'@**************************************************************************************************
'@ TestStory: Test #4 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
'Create a loan with 9 months - with 60 months interest
strConstrLoan=BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_9Mo60Interest")

'AP Validations-Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 9 Months, 60 Months Interest Only
If UTIL_String_IsNotEmpty(strConstrLoan)=True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_9Mo60Interest"
Else
