'@**************************************************************************************************
'@ TestStory: Test #1 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-566", "Test #1 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null    
    
'Go to Settings/'Tables and Fees/"Escrow

BIZ_Forms_Open "Construction Management"
'Create a loan with 9 months - no interest
strConstrLoan = BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_9MoNoInterest")

'AP Validations-Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 9 Months, No Interest Only
If UTIL_String_IsNotEmpty(strConstrLoan)=True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_9MoNoInterest"
Else
