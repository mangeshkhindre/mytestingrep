'@**************************************************************************************************
'@ TestStory: Test #9 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-571", "Test #9 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null
...
strConstrLoan=BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_12Mo36MInterest240Ballons_withMortage")

'Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 12 Months, Interest Only = 36 months, Balloon = 240 Months, Mortgage Insurance
...
If UTIL_String_IsNotEmpty(strConstrLoan)=True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_12Mo36MInterest240Ballons_withMortage"
Else
