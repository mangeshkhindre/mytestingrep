'@**************************************************************************************************
'@ TestStory: Test #3 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-564", "Test #3 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null

'Go to Settings/Tables and Fees/Escrow


'Create a loan with 13 months - no interest
strConstrLoan = BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_13MoNoInterest")

'AP Validations-Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 13 Months, No Interest Only
If UTIL_String_IsNotEmpty(strConstrLoan) = True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_13MoNoInterest"
Else
