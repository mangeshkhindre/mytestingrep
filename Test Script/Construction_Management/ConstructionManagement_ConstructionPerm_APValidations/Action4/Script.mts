'@**************************************************************************************************
'@ TestStory: Test #2 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
'@ ExpectedResult:
   ...
   '  First Change/Amount = $955 at 13th payment
   '  Subsequent Changes = No subsequent changes
   '  Maximum Payment = $955 starting at 13th payment

'***************************************************************************************************

FRM_Logger_ReportStepEvent "Start Test Case: PTAC-565", "Test #2 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null

'Go to Settings/'Tables and Fees/"Escrow

BIZ_Forms_Open "Construction Management"
'Create a loan with 12months - without interest
strConstrLoan = BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_12MoNoInterest")

'AP Validations-Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 12 Months, No Interest Only
If UTIL_String_IsNotEmpty(strConstrLoan) = True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_12MoNoInterest"
Else
	FRM_Logger_ReportFailEvent "AP Validations", "Unable to perform validations as Loan has not Created successfully", Null
End IF
