'@**************************************************************************************************
'@ TestStory: Test #8 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-570", "Test #8 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null
    
'Go to Settings/'Tables and Fees/"Escrow

BIZ_Forms_Open "Construction Management"
'Create a loan with 9 Months, Interest Only = 6 months, Balloon = 240 Months, Mortgage Insurance
strConstrLoan = BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_9Mo6MInterest_withMortage")

'Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 9 Months, Interest Only = 6 months, Balloon = 240 Months, Mortgage Insurance
...
If UTIL_String_IsNotEmpty(strConstrLoan)=True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_9Mo6MInterest_withMortage"
Else
