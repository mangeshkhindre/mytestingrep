'@**************************************************************************************************
'@ TestStory: Test #6 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-569", "Test #6 (CBIZ-3706): Construction to Perm Loans - Adjustable Payment (AP) Table logic - STEP RATE", Null
 
'Go to Settings/'Tables and Fees/"Escrow

BIZ_Forms_Open "Construction Management"
'Create a loan with 13 months - with 6 months interest
strConstrLoan=BIZ_ConstructionManagement_LoanCreation("ConstructionManagement_13Mo6MInterest")

'AP Validations-Construction to Perm, Fixed to Fixed with Step Rate, Construction Period = 13 Months, 6 Months Interest Only
If UTIL_String_IsNotEmpty(strConstrLoan)=True Then
	BIZ_RegZLE_AP_validations "ConstructionManagement_13Mo6MInterest"
Else
