...
'@ TestCase: PTAC-864  - TC 7 - CBIZ- 3873- Estimated escrow row calculation for Construction to Perm for ARM rate
...
'@ Pre-conditions:
'@ Description: Estimated escrow row calculation for Construction to Perm for ARM rate
'@ TestSteps:
...
FRM_Logger_ReportStepEvent	"Start Test Case : PTAC-864","Test Case : TC 7 - CBIZ- 3873- Estimated escrow row calculation for Construction to Perm for ARM rate",Null
...
BIZ_Forms_LoanEstimate_VerifyEstimatedEscrow "1352_ConstrPerm_EstEscrow_864"
