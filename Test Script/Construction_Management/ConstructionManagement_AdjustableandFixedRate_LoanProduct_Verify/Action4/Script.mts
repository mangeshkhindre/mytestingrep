...
Set objData = FRM_DS_GetTestData("Forms_RegZ-LE", "SetConstruction", Parameter("strRowID"))

strPeriod = FRM_DS_GetValue(objData, "1176_Period")

BIZ_Forms_Open "RegZ - LE"

'Set Construction Period 
FRM_Logger_ReportInfoEvent "Set Construction Period","Product verify for Construction Period "&strPeriod&" Months",Null
BIZ_RegZ_LE_SetConstructionMortgage Parameter("strRowID")
Wait g_LongWaitMedium

'Validate Product in LEandCD for Construction Period
BIZ_ConstructionManagement_LEandCD_LoanProduct_Verify Parameter("strRowID"), Parameter("strLoanPage1"),Parameter("strAmortizationType")
BIZ_ConstructionManagement_LEandCD_LoanProduct_Verify Parameter("strRowID"), Parameter("strLoanPage2"), Parameter("strAmortizationType")
