...
'@ TestData: 
   ...
   '12 Forms_RegZ-CD,RegZ_CD,PTAC-1352_LEandCD_Amortization_Fixed
   '13 Forms_RegZ-CD,RegZ_CD,PTAC-1352_LEandCD_Amortization_ARM
...
FRM_Logger_ReportInfoEvent "Start Test Case- PTAC-1737", "ConstructionManagement_AdjustableandFixedRate_LoanProductVerify", Null

'====== Login to the Encompass as admin ======
BIZ_Login_UserLogin "admin_core2p"

'====== Run Action to Verify Loan Product for Fixed interest type Loan ======  
FRM_Logger_ReportStepEvent "Start Test Case- PTAC-615", "TC 1 - CBIZ-4696 - Construction Loans - Loan Product (LE1.X5) logic for Amortization Type - Fixed Rate", Null
RunAction "ConstructionManagement_AdjustableAndFixedRate_LoanProductVerify_001", oneIteration, "PTAC-1352_LEandCD_Amortization_Fixed","FixedRate"

'====== Run Action to Verify Loan Product for Adjustable interest type Loan ======
FRM_Logger_ReportStepEvent "Start Test Case- PTAC-801", "TC 2 - CBIZ-4696 - Construction Loans - Loan Product (LE1.X5) logic for Amortization Type - Adjustable Rate", Null
RunAction "ConstructionManagement_AdjustableAndFixedRate_LoanProductVerify_001", oneIteration, "PTAC-1352_LEandCD_Amortization_ARM","AdjustableRate"
