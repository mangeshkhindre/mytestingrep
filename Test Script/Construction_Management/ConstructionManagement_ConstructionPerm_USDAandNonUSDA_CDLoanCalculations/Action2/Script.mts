...
'@ TestCase: PTAC-611 - Test Case:TC #1 (CBIZ-1477) - Construction-to-Perm Loans - CD Loan Calculations Table logic (Non-USDA)  
...
'@ ExpectedResult:
   ...
   '5 It should display the Loan Calculations section as below,
	'Total of Payments (CD5.X1) = $185845.36
	'Finance Charge (1206) = $83867.60
	'Amount Financed (948) = $100000
	'APR (799) = 4.673%TIP (LE3.X16) = 73.879 
'***************************************************************************************************

FRM_Logger_ReportStepEvent "Start Test Case : PTAC-611","Test Case:TC #1 (CBIZ-1477) - Construction-to-Perm Loans - CD Loan Calculations Table logic (Non-USDA)", Null

'Navigate to pipeline>>Construction mangement
BIZ_Nav_Pipeline_Forms_FormType "My Pipeline","Construction Management"

'Set data in CM page 
BIZ_ConstructionManagement_SetLoanInfoDetails "1352_ConstrPerm_NonUSDA"

'Set data in Closing Disclosure page 1
BIZ_ClosingDisclosurePage1_SetClosingInformation "1352_ConstrPerm_NonUSDA"
 
'Set data in Aggregate Escrow Account Page
BIZ_Forms_AggregateEscrowAccount_SetData "1352_ConstrPerm_NonUSDA"

'Set data in BSO form
BIZ_BorrowerSummaryOrigination_SetBorrower "1352_ConstrPerm_NonUSDA"

'Set data in RegZ-LE Page
BIZ_Forms_Open "RegZ - LE"
BIZ_RegZ_LE_SetConstructionMortgage "1352_ConstrPerm_NonUSDA"

'Set data in RegZ-CD page
BIZ_Forms_Open "RegZ - CD"
BIZ_RegZ_CD_SetConstructionMortgage "1352_ConstrPerm_NonUSDA"
BIZ_Common_RegZ_CD_SetMiandPiDetails "1352_ConstrPerm_NonUSDA"
...
BIZ_2015Itemization_Set800Section "1352_ConstrPerm_NonUSDA"

'Set Data in 1000 section of 2015 ItemizationPage
BIZ_2015Itemization_Set1000Section "1352_ConstrPerm_NonUSDA"

'Set data in 2015 itemization form
BIZ_Forms_Open "2015 Itemization"

'Set fee details data in 834 section of 2015 ItemizationPage
BIZ_2015Itemization_SetFeeDetails "834","1352_ConstrPerm_NonUSDA_834"

'arrStrCheckbox = Array("Seller Obligated")
...
BIZ_2015Itemization_SetFeeDetails "835","1352_ConstrPerm_NonUSDA_835"
...
BIZ_2015Itemization_SetFeeDetails "1115","1352_ConstrPerm_NonUSDA_1115"
...
BIZ_2015Itemization_SetFeeDetails "1116","1352_ConstrPerm_NonUSDA_1116"
...
BIZ_ClosingDisclosurePage5_VerifyLoanCalculations "1352_ConstrPerm_NonUSDA"
...
BIZ_Loan_Exit True
 ...
 @@ hightlight id_;_SwfWindow("Encompass - Build 17.1.0.0").Page("Page").WebEdit("WebEdit 4")_;_script infofile_;_ZIP::ssf4.xml_;_
