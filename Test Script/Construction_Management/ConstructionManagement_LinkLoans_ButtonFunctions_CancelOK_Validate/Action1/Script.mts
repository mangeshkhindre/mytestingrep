...
FRM_Logger_ReportInfoEvent "Start Test Case- PTAC-1542","ConstructionManagement_LinkLoans_ButtonFunctions_CancelOK_Validate", Null 

'====== Login to the Encompass as admin ======
BIZ_Login_UserLogin "admin_core2p"

'====== Run Action to validate Button Functions - 'Go To Construction' button (Link to Perm button); if 'Cancel' is clicked ======
FRM_Logger_ReportStepEvent "Start Test Case -PTAC-1184","TC #36 - CBIZ-2857; Button Functions - 'Go To Construction' button (Link to Perm button); if 'Cancel' is clicked", Null 
RunAction "ConstrMgmt_Linkloan_CashoutRefi_LinkLoans", oneIteration
ConstructionManagement_GoToConstruction_GoToPermButton_CancelOperation_UIValidate "PTAC-1352_ConstructionOnly"
BIZ_Loan_Exit True
BIZ_Nav_SelectHomeTab()

'====== Run Action to validate Button Functions - 'Go To Construction' button (2nd Loan; Link to Perm button); if 'Ok' is clicked ======
FRM_Logger_ReportStepEvent "Start Test Case -PTAC-1185","TC #35 - CBIZ-2857; Button Functions - 'Go To Construction' button (2nd Loan; Link to Perm button); if 'Ok' is clicked", Null 
RunAction "ConstrMgmt_Linkloan_CashoutRefi_LinkLoans", oneIteration,strCashOutRefiananceLoanNumber,strConstructionLoanNumber
ConstructionManagement_GoToConstruction_GoToPermButton_OKOperation_UIValidate "PTAC-1352_ConstructionOnly",strConstructionLoanNumber,strCashOutRefiananceLoanNumber
BIZ_Loan_Exit True
BIZ_Nav_SelectHomeTab()
