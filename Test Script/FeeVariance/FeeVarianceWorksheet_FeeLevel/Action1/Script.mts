'@**************************************************************************************************
'@ TestStory: CTA-418 Fee Level Fee Variance
'@ TestCase:
   '1 CTA-419 Fee Level Fee Variance
...
'====== Validate GFE Alert =======
FRM_Logger_ReportStepEvent "Step-7: Verify Items in Fee Variance Worksheet after baseline Fees updated and GFE Alert", "Validating Items in Fee Variance Worksheet after baseline Fees updated and GFE Alert",Null
...
boolGFEAlert	=	BIZ_AlertsAndLog_ClickOnRecord ("Alerts & Messages", "Good Faith Fee Variance Violated")
FRM_VerifyTrue boolGFEAlert, "GFE Alert", "The GFE Alert Fired"
BIZ_FeeDetails_SelectCoCReason "LE_CoC_InvalidReason"
...
'============ Verify the Items in Fee Variance Worksheet=============
FRM_Logger_ReportStepEvent "Step-9: Verify Items in Fee Variance Worksheet after Revised LE with invalid CoC reason", "Validating Items in Fee Variance Worksheet after Revised LE with invalid CoC reason",Null
BIZ_Tools_Open "Fee Variance Worksheet"
''=====verify Items That Cannot Decrease section in Fee Variance Worksheet====
...
boolGFEAlert	=	BIZ_AlertsAndLog_ClickOnRecord ("Alerts & Messages", "Good Faith Fee Variance Violated")
FRM_VerifyTrue boolGFEAlert, "GFE Alert", "The GFE Alert Fired"
BIZ_FeeDetails_SelectCoCReason "LE_CoC_ValidReason"
...
'============ Verify the Items in Fee Variance Worksheet=============
FRM_Logger_ReportStepEvent "Step-11: Verify Items in Fee Variance Worksheet after Revised LE with valid CoC reason", "Validating Items in Fee Variance Worksheet after Revised LE with valid CoC reason",Null
BIZ_Tools_Open "Fee Variance Worksheet"
''=====verify Items That Cannot Decrease section in Fee Variance Worksheet====  
...
'============ Verify the Items in Fee Variance Worksheet=============
FRM_Logger_ReportStepEvent "Step-13: Verify Items in Fee Variance Worksheet after Initial CD", "Validating Items in Fee Variance Worksheet after Initial CD",Null
BIZ_Tools_Open "Fee Variance Worksheet"
''=====verify Items That Cannot Decrease section in Fee Variance Worksheet====
...
boolGFEAlert	=	BIZ_AlertsAndLog_ClickOnRecord ("Alerts & Messages", "Good Faith Fee Variance Violated")
FRM_VerifyTrue boolGFEAlert, "GFE Alert", "The GFE Alert Fired"
BIZ_FeeDetails_SelectCoCReason "CD_CoC_InvalidReason"
...
'============ Verify the Items in Fee Variance Worksheet============= 
FRM_Logger_ReportStepEvent "Step-17: Verify Items in Fee Variance Worksheet after Revised CD with invalid reason", "Validating Items in Fee Variance Worksheet after Revised CD",Null
BIZ_Tools_Open "Fee Variance Worksheet"
''=====verify Items That Cannot Decrease section in Fee Variance Worksheet====
...
'======check Changed Circumstance and select valdi reason======
...
boolGFEAlert	=	BIZ_AlertsAndLog_ClickOnRecord ("Alerts & Messages", "Good Faith Fee Variance Violated")
FRM_VerifyTrue boolGFEAlert, "GFE Alert", "The GFE Alert Fired"
BIZ_FeeDetails_SelectCoCReason "CD_CoC_ValidReason"
...
'============ Verify the Items in Fee Variance Worksheet=============
FRM_Logger_ReportStepEvent "Step-19: Verify Items in Fee Variance Worksheet after Revised CD with valid CoC Reason", "Validating Items in Fee Variance Worksheet after Revised CD with valid CoC Reason",Null
boolGFEAlert	=	BIZ_AlertsAndLog_ClickOnRecord ("Alerts & Messages", "Good Faith Fee Variance Violated")
