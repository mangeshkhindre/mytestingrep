...
dtCoBorrActualRecDate=BIZ_DisclosureTracking_DateCalculation(cdate(arrInitialLESentDates(1)),1,"Reg_ZBusinessCalender")
...
dtCoBorrActualRecDate=BIZ_DisclosureTracking_DateCalculation(cdate(arrInitialLESentDates(2)),1,"Reg_ZBusinessCalender")
...
dtCoBorrActualRecDate=BIZ_DisclosureTracking_DateCalculation(cdate(arrRevisedLESentDates(1)),1,"Reg_ZBusinessCalender")
...
dtCoBorrActualRecDate=BIZ_DisclosureTracking_DateCalculation(cdate(arrRevisedLESentDates(2)),1,"Reg_ZBusinessCalender")
