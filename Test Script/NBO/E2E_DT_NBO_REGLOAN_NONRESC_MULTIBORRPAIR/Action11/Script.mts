...
'======= Set Borrower Pair-2 Actual Received Dates for Initial CD and Validating IntialCDReceived for Pair-2 ============
...
'==== Verifying NBO received date with CD Received date====
...
FRM_VerifyNotEqual CDate(dtExpCDReceived),CDate(dtNBOActualRecDate),"CD Received Date","NBOs Date is not considered in CD Received Date calculation"
...
BIZ_DisclosureTracking_MultipleBorrPair_AddDisclosure strBorrPair3,"CD"
arrRevisedBorrPair3=BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Revised","CD",arrRevisedCDSentDates(2),"","","Yes","Yes") 
...
arrRevisedBorrPair3=BIZ_DisclosureTrackingTool_BorrPair_SetDisclosureDetail(strBorrPair3,"Revised","CD","",dtActualRec_BorrPair3,dtActualRec_CoBorrPair3,"No","Yes")
dtCDSent=BIZ_DisclosureTracking_CDSentDateCalculation(arrRevisedBorrPair1,arrRevisedBorrPair2,arrRevisedBorrPair3,arrRevisedCDSentDates,"Earliest")
dtExpCDReceived=BIZ_DisclosureTracking_CDReceivedDateCalculation(arrRevisedBorrPair1,arrRevisedBorrPair2,arrRevisedBorrPair3,"Earliest")
...
'dtNBOActualRecDate=DateAdd("d",-2,cdate(dtActualRec_CoBorrPair3))
dtNBOActualRecDate=BIZ_DisclosureTracking_DateCalculation(DateAdd("d",-1,cdate(dtActualRec_CoBorrPair3)),-1,"Reg_ZBusinessCalender")
FRM_VerifyNotEqual CDate(dtExpCDReceived),CDate(dtNBOActualRecDate),"Revised CD Received Date","NBOs Date is not considered in Revised CD Received Date calculation"
