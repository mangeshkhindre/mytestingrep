...
'@ TestCase: PTAC-3195 The objective of test case is to verify synced Business Contacts-Custom Letters in Environment 2 should match with Environment 1
...
'@ TestSteps:
   ...
   '2 In the Environment1, Select Settings-> Contacts -> Business Contacts-Custom Letters
...
'***************************************************************************************************
FRM_Logger_ReportInfoEvent "Start Test Case : PTAC-3195","The objective of test case is to verify synced Business Contacts-Custom Letters in Environment 2 should match with Environment 1", Null

'================Business Contacts - Customm Letters tab selction===============
GUI_SwfTab_Click SwfWindow("Swfname:=SettingsToolMain").SwfTab("swfname:=tabCtrlMain","index:=1"), "Business Contacts - Custom Letters"
Wait g_ShortWaitMedium

strCompName = SyncSettings_Contacts_CreateCustomLettersPersonas("SyncSettings_BizContact", "Business Contacts - Custom Letters", 1)
...
Wait g_LongWaitSmall
Settings_Sync_Contacts_ValidateDocumentData strCompName&".docx", "SyncSettings_BizContact"
