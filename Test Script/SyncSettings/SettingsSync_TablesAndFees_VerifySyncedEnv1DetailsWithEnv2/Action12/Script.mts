...
'@ TestCase: PTAC-3327 The objective of test case is to verify synced 'Title' in Environment 1 should match with Environment 2
...
'@ Description: The objective of test case is to verify synced 'Title' in Environment 1 should match with Environment 2
'@ TestSteps:
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-3327", "The objective of test case is to verify synced 'Title' in Environment 1 should match with Environment 2", Null
