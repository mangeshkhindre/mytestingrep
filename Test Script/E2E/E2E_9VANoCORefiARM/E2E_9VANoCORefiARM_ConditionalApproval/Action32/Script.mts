...
'@ TestCase : PTAC-2358 Conditional Approval 4 - Finish Milestone
...
'@ ExpectedResult: 
	'1 Conditional approval window will open 
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2358","Conditional Approval 4 - Finish Milestone", Null

Dim objData
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_VANoCORefiARM_ConditionalApproval")

BIZ_Document_AttachMandatoryDocuments "Cond. Approval", "E2E_VANoCORefiARM_ConditionalApproval"
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Cond. Approval finished")) Then 
    ...
    GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS6Complete_VANoCORefiARM"
End If
