...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2373","Funding 1- Complete the funding worksheet", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS9Complete_VANoCORefiARM","Funding"
...
BIZ_FundingWorksheet_SetFundingClosing "E2E_VANoCORefiARM"
BIZ_FundingWorksheet_SetFundingSource "E2E_VANoCORefiARM"
BIZ_FundingWorksheet_SetWireInformation "E2E_VANoCORefiARM"

'Select all checkboxes at the end of Funding Worksheet
BIZ_FundingWorksheet_CheckFeeLines()

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_VANoCORefiARM_Funding")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Funded")) Then 
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS10Complete_VANoCORefiARM"
End If
