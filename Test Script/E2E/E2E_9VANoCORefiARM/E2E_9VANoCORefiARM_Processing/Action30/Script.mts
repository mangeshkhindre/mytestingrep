...
'@ TestCase: PTAC-2336 - Processing 8- Order Title
'@ Test Automation JIRA Task: PTAC-2897 - E2E_9VANoCORefiARM_Processing
'@ TestData: 
	'1 Services, TitleNClosing and E2E_VANoCORefiARM
	'2 Global_Data, Website and E2E_VANoCORefiARM_TitleCenter
	'3 Services, TitleService and E2E_VANoCORefiARM
	'4 eFolder_Tab, AttachDocuments and E2E_VANoCORefiARM
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
	'Step1:
	...
	'4 Fill phone number and select check box-request fee quote and comment- yes. select title tab. checkbox-order title. 
	   'under product select alta.jr.title policy. under closing and escrow checkbox -order closing/escrow. 
	'5 select closing/escrow services and click submit order. click ok.
	'Step2:
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2336","Processing 8- Order Title", Null

Dim objData, blnDocumentStatus
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_VANoCORefiARM_Processing")

BIZ_Services_SetOrderTitleAndClosing "E2E_VANoCORefiARM"
GUI_Dialog_Encompass_OK("")
GUI_Browser_CloseAllBrowsers g_DefaultBrowser
GUI_Browser_CloseAllBrowsers g_DefaultBrowser

BIZ_Services_LoginTitleCenter "E2E_VANoCORefiARM_TitleCenter"
BIZ_Services_ProcessTitleCenterDetailsAndSendDocument "E2E_VANoCORefiARM"
GUI_Dialog_Encompass_OKX 5, ""

BIZ_Services_ImportTitleDocument ""
BIZ_Nav_eFoler_Open()
BIZ_Documents_AttachDocuments "E2E_VANoCORefiARM"
...
BIZ_Document_AttachMandatoryDocuments "Processing", "E2E_VANoCORefiARM_Processing"
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Processing")) Then
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS4Complete_VANoCORefiARM"	
End If
