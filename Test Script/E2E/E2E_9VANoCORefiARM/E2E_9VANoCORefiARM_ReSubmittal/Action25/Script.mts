...
'@ TestCase : PTAC-2361 Resubmittal 2- Get Rate Locked
'@ Test Automation JIRA Task: PTAC-2961 E2E_9VANoCORefiARM_ReSubmittal
'@ TestData: Loans, LoanTemplate and E2E_SecondaryMarketing
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
...
'@ ExpectedResult:
   '1 Should be able to login. Loan should open with secondary registration page.
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2361","Resubmittal 2- Get Rate Locked", Null

Dim blnDaysExists, MainPage, intNumberOfLockRequests, strLoanNumber, objData, objSnapShotGrid, objSecondaryLockTool, objRequest, ObjLockRequestForm
...
If (intNumberOfLockRequests > 0) Then 
    ...
    If objSecondaryLockTool.SwfWindow("swfname:=DifferencesChangeDialog").SwfButton("swfname:=button1").Exist(60) Then 
