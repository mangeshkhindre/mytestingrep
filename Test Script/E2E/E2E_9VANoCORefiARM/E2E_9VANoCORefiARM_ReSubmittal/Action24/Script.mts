...
'@ TestCase : PTAC-2360 Resubmittal 1-Get Rate Lock request and LO comp plan and Float.
...
'@ Description:  
'@ TestSteps:
   '01 Login to Encompass as Loan Processor and click Accept File
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2360","Resubmittal 1-Get Rate Lock request and LO comp plan and Float.", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS6Complete_VANoCORefiARM","Resubmittal"
...
If ((BIZ_LockRequestForm_ProductNPricingFromGetPricing("E2E_VANoCORefiARM", "Float") = True)) Then 
	...
	If (InStr(lcase(strLockRequestedLabelText), "Lock Requested") > 0) Then 
