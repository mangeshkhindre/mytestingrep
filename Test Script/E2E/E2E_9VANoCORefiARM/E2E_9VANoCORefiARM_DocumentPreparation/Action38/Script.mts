...
'@ TestCase : PTAC-2369 Doc Preparation 4 - Encompass compliance services
...
'@ TestSteps:
	'1 Under Forms go to ATR/QM management.
	   'Click on ATR/QM eligibility tab.
	   'For Qualified Mortgage Loan type select blank from the dropdown.	
...
'@ ExpectedResult: 
	'1 ATR/QM management page should open.
	  'ATR/QM eligibility tab should open.
	  'Should be able to select blank.
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC- 2369","Doc Preparation 5- Encompass compliance services", Null

Dim objBorrowerPages
...
BIZ_TQLServices_SubmitOrder "Compliance Service", "E2E_VANoCORefiARM"
