...
'@ TestCase : PTAC-2210 Conditional Approval 3 - Clear conditions.
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-2210","Conditional Approval 3 - Clear conditions", Null

Dim intRowCount, strConditionName, blnConditionFullfilled, strConditionNameSelected, intRowNumber
'====== Clicks on eFolder ======
BIZ_Nav_eFoler_Open()
...
Else
	FRM_Logger_ReportFailEvent "Check the fulfilled condition for each condtion", "Preliminary conditions are not fulfilled", Null
End If
