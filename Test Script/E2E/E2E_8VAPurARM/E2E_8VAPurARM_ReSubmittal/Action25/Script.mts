...
'@ TestCase: PTAC-2223 - Resubmittal 2- Get Rate Locked
'@ Test Automation JIRA Task: PTAC-2404  E2E_8VAPURARM_Resubmittal
'@ TestData:
	'1 Loans, LoanTemplate and E2E_SecondaryMarketing
	'2 Global, Login and E2E_Secondary
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   ...
   '3 Select your loan by your loan number and open the loan. 
   '4 Under the lock request snapshot select the first line by double clicking on it. 
   '5 Click Copy from request and then click Copy from buy side button and click Lock and Confirm button
   '6 Click confirm in the current loan data window
   '7 Click Update button in the pricing import window
   '8 Click ok in the Encompass lock confirmation window
'@ ExpectedResult:
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-2223","Resubmittal 2-Get Rate Locked", Null

Dim blnDaysExists, intNumberOfLockRequests, strLoanNumber, objData, objSnapShotGrid, objSecondaryLockTool, objRequest, objMainPage, ObjLockRequestForm
