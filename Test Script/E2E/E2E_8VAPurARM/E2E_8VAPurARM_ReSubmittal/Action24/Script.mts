...
'@ TestCase: PTAC-2222 - Resubmittal 1-Get Rate Lock request and LO comp plan and Float.
'@ Test Automation JIRA Task: PTAC-2404  E2E_8VAPURARM_Resubmittal
'@ TestData:
	'1 Loans, LoanTemplate and E2E_LoanProcessorDefault
	'2 Global, Login and E2E_carollp
'@ Pre-conditions:   
'@ Description:  
'@ TestSteps:
...
Dim strLoanNumber, strLockRequestedLabelText, objData
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS6Complete_VAPURARM","Resubmittal"

If (GUI_Object_IsExistX(SwfWindow("swfname:=MainForm").Dialog("text:=Encompass").Static("text:=You only have read-only access to this loan file.*"), 50))Then 
