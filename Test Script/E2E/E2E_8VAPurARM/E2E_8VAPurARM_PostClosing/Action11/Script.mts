...
'@ TestCase : PTAC-2252 - Post Closing 1 - Add Post Closing conditions 
...
'@ TestSteps:
	...
	'5 Select 'Final Title Policy' and click add. 	'Select 'MERS Transfer' and click add. 'Click 'Add' button in the condition sets window.
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-2252","Post Closing 1 - Add Post Closing conditions", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS10Complete_VAPURARM","Post Closing"
...
BIZ_PostClosingConditions_AddConditionsFromSet "E2E_VAPURARM1"
'Clear the Closing Conditions
BIZ_PostClosingConditions_SetAllConditionsStatus "E2E_VAPURARM"
