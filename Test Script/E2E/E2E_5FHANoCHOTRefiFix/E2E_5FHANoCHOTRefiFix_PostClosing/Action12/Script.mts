...
'@ TestCase: PTAC-2189 FHANOCHOTREFIFIX Post Closing 3 - Order Encompass Compliance services
'@ Test Automation JIRA Task: PTAC-2710 E2E_5FHANoCHOTRefiFix_PostClosing
'@ TestData: 
	'1 Loans, Milestone, E2E_FHANoCHOTRefiFix_PostClosing
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
	'1 Login as shipper.
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2189","FHANOCHOTREFIFIX Post Closing 3 - Order Encompass Compliance services", Null

Dim objData

BIZ_TQLServices_SubmitOrder "Compliance Service","" 

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHANOCHOTREFIFIX_PostClosing")
