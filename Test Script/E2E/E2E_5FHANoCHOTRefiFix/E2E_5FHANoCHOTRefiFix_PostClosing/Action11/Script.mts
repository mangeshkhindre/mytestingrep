...
'@ TestCase: PTAC-2187 FHANOCHOTREFIFIX Post Closing 1 - Add Post Closing conditions
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2187","FHANOCHOTREFIFIX Post Closing 1 - Add Post Closing conditions", Null

Dim strLoanNumber, objData, objDataUser

Set objData 	= FRM_DS_GetTestData("Loans", "LoanTemplate", "E2E_PostCloser")
Set objDataUser = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHANOCHOTREFIFIX_PostClosing")
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS11Complete_FHANoCHOTRefiFix","Post Closing"
...
BIZ_PostClosingConditions_AddConditionsFromSet "E2E_FHANoCHOTRefiFix1"
'Clear the Closing Conditions
BIZ_PostClosingConditions_SetAllConditionsStatus "E2E_FHANoCHOTRefiFix"
