...
'@ TestCase : PTAC-2019 FHANOCHOTREFIFIX Resubmittal 4- Finish Milestone
...
'@ TestSteps:
   ...
   '5 Click the magnifying lens next to loan processor and select markusuw.
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2019","FHANOCHOTREFIFIX Resubmittal 4- Finish Milestone", Null

BIZ_Document_AttachMandatoryDocuments "Resubmittal", "E2E_FHANoCHOTRefiFix_ReSubmittal"

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHANOCHOTREFIFIX_ReSubmittal")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Resubmittal finished")) Then 
    ...
    GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS7Complete_FHANoCHOTRefiFix"
End If
