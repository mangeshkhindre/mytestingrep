...
'@ TestCase : PTAC-2023 FHANOCHOTREFIFIX Approval 2 - Finish Approval milestone
'@ Test Automation JIRA Task: PTAC-2707 E2E_5FHANoCHOTRefiFix_Approval
'@ TestData: 
	'Loans, Milestone, E2E_CONVPURARM_Approval
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2023","FHANOCHOTREFIFIX Approval 2 - Finish Approval milestone", Null
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Approved")) Then 
    ...
    GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS8omplete_FHANoCHOTRefiFix"
End If
