...
'@ TestCase : PTAC-2190 FHANOCHOTREFIFIX Shipping 1 - Complete shipping detail form
'@ Test Automation JIRA Task: PTAC-2711 E2E_5FHANoCHOTRefiFix_Shipping
'@ TestData: 
   '1 Tools_ShippingDetail, SetShippingDetail and E2E_FHANoCHOTRefiFix
   '2 Tools_ShippingDetail, SetShipTo and E2E_FHANoCHOTRefiFix
   '3 Tools_ShippingDetail, SetPhysicalFileStorage and E2E_FHANoCHOTRefiFix
...
FRM_Logger_ReportInfoEvent "Start Test Case: PTAC-2711","Script Name - E2E_5FHANoCHOTRefiFix_Shipping", Null

Dim objData, strLoanNumber

FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2190","FHANOCHOTREFIFIX Shipping 1 - Complete shipping detail form", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS11Complete_FHANoCHOTRefiFix","Shipping"
BIZ_Tools_Open "Shipping Detail"
BIZ_ShippingDetail_SetShippingDetail "E2E_FHANoCHOTRefiFix"
BIZ_ShippingDetail_SetShipTo "E2E_FHANoCHOTRefiFix"
BIZ_ShippingDetail_SetPhysicalFileStorage "E2E_FHANoCHOTRefiFix"
...
Set objDataShipping = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHANOCHOTREFIFIX_Shipping")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Shipping finished")) Then 
    ...
    GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS13Complete_FHANOCHOTREFIFIX"
