...
'@ TestCase : PTAC-2143 FHANOCHOTREFIFIX Doc Preparation 4 - Encompass compliance services
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2143","FHANOCHOTREFIFIX Doc Preparation 4 - Encompass compliance services", Null
...
objBorrowerPage.WebElement("innertext:=Recording Fees","html tag:=SPAN").Highlight
objBorrowerPage.WebEdit("html id:=TextBox44").Set ""

BIZ_TQLServices_SubmitOrder "Compliance Service", "E2E_FHANOCHOTREFIFIX"
