...
'@ TestCase : PTAC-2671 FHACOREFIARM Resubmittal 1-Get Rate Lock request and LO comp plan and Float.
...
'@ ExpectedResult:
    ...
    '10 In the header section lock requested message should be seen next to the lock icon.
    '11 Loan should be saved. 
'***************************************************************************************************

FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2671","FHACOREFIARM Resubmittal 1-Get Rate Lock request and LO comp plan and Float.", Null

Dim strLoanNumber, strLockRequestedLabelText, objDataResubmittal, objData
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS6Complete_FHACORefiARM","Resubmittal"
