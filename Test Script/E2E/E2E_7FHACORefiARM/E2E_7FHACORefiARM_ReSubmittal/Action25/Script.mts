...
'@ TestCase : PTAC-2672 FHACOREFIARM Resubmittal 2-Get Rate Locked
'@ Test Automation JIRA Task: PTAC-2719 E2E_7FHACORefiARM_ReSubmittal
'@ TestData: Add Test data file name, Sheet name and Row Id.
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   '1 In your loan Right Click Lock icon from the header.select secondary registration
...
'@ ExpectedResult:
   '1 Loan should open with secondary registration snapshot list
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2672","FHACOREFIARM Resubmittal 2-Get Rate Locked", Null
...
If (intNumberOfLockRequests > 0) Then 
	...
	If (SwfWindow("swfname:=MainForm").SwfWindow("swfname:=UserPasswordDialog").Exist(10)) Then 
        ...
        'Click on Rate Link
		BIZ_LockRequestForm_ImportPricing "E2E_FHACORefiARM", "Float"
