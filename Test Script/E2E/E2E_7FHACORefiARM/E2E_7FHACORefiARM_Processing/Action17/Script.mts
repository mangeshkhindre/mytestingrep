...
'@ TestCase : PTAC-2620 FHACOREFIARM Processing 7- Order Appraisal
'@ Test Automation JIRA Task: PTAC-2716 E2E_7FHACORefiARM_Processing
'@ TestData: 
	'1 Tools_OrderAppraisal, SetOrderAppraisal, E2E_FHACORefiARM
	'2 Global_Data, Website, E2E_FHACORefiARM_Appraisal
	'3 Services, AppraisalService, E2E_FHACORefiARM
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   'Step1 test Steps:
   ...
   'Step2 test Steps:
	...
	'4 Under appraisal documents click 'browse' for attached appraisal pdf select any pdf and enter appraiser name as 'appraiser clark' and appraiser Id as '2394098'.
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2620","Test Case Name - FHACOREFIARM Processing 7- Order Appraisal", Null

BIZ_Tools_SendOrderAppraisal "E2E_FHACORefiARM"
BIZ_Services_LoginAppraisalCenter "E2E_FHACORefiARM_Appraisal"  
BIZ_Services_ProcessAppraisalCenterAndSendDocument "E2E_FHACORefiARM"
