...
'@ TestCase : PTAC-2661 FHACOREFIARM Conditional Approval 4 - Finish Milestone
'@ Test Automation JIRA Task: PTAC-2718 E2E_7FHACORefiARM_ConditionalApproval
'@ TestData: Loans, Milestone and E2E_FHACORefiARM_ConditionalApproval
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
...
'***************************************************************************************************
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2661","FHACOREFIARM Conditional Approval 4 - Finish Milestone", Null

Dim objData
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHACORefiARM_ConditionalApproval")

BIZ_Document_AttachMandatoryDocuments "Cond. Approval", "E2E_FHACORefiARM_ConditionalApproval"
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Cond. Approval finished")) Then 
    ...
    GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS6Complete_FHACORefiARM"
End If
