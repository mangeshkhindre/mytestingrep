'@**************************************************************************************************
 ...
 '@ TestCase: PTAC-2730 - FHACOREFIARM Doc Preparation 6- Complete REGZ-CD
 '@ Test Automation JIRA Task: PTAC-2721 E2E_7FHACORefiARM_DocumentPreparation
 '@ TestData: 
 	'1 Forms_REGZ_CD, SelectPlanCode, E2E_FHACORefiARM
 	'2 Forms_RegZ_CD, SetLoanInformation, E2E_FHACORefiARM
	'3 Forms_RegZ_CD, OrderDocs, E2E_FHACORefiARM
	'4 Forms_RegZ_CD, RegZ_CD, E2E_FHACORefiARM
 '@ Pre-conditions: 
 '@ Description: 
 '@ TestSteps:
...
FRM_Logger_ReportInfoEvent "Start Test Case : PTAC-2730","Test Case Name: Doc Preparation 6- Complete REGZ-CD", Null

Dim objData
BIZ_Forms_ClosingDisclosurePage5_ClickCopyFrom1003Page "E2E_FHACORefiARM"

BIZ_Forms_Open "RegZ - CD"
BIZ_REGZ_CD_SelectPlanCode "E2E_FHACORefiARM"

GUI_Dialog_Encompass_YesX 30, ""

BIZ_RegZ_CD_SetLoanInformation "E2E_FHACORefiARM"
BIZ_RegZ_CD_SetData "E2E_FHACORefiARM"
BIZ_RegZ_CD_AuditOrderDocs "E2E_FHACORefiARM"
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Doc Preparation finished")) Then 
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS9Complete_FHACORefiARM"
End If
