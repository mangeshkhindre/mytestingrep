...
'@ TestCase: PTAC-1395 - CONVNOCASHREFIARM - Conditional Approval 4 - Finish Milestone
...
'@ ExpectedResult: 
	...
	'5 Window should close.Milestone should be finished
'***************************************************************************************************
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1395","Test Case Name: CONVNOCASHREFIARM - Conditional Approval 4 - Finish Milestone", Null
Dim objData
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_ConvNoRefiARM_ConditionalApproval")

BIZ_Document_AttachMandatoryDocuments "Cond. Approval", "E2E_ConvNoRefiARM_ConditionalApproval"
...
If(BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Cond. Approval finished")) Then 
   ...
   GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS6Complete_ConvNoRefiARM"
End If
