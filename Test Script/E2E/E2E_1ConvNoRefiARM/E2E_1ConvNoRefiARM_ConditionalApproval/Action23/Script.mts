...
'@ TestCase: PTAC-1394 - CONVNOCASHREFIARM - Conditional Approval 3 - Clear conditions.
'@ Test Automation JIRA Task:PTAC-1783 - E2E_1ConvNoRefiARM_ConditionalApproval
'@ TestData: 
	'1 eFolder_Tab,SetPreliminaryConditionStatus,E2E_ConvNoRefiARM
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   '1 Click e-folder
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1394","Test Case Name: CONVNOCASHREFIARM - Conditional Approval 3 - Clear conditions.", Null
...
BIZ_PreliminaryConditions_SetAllConditionsStatus "E2E_ConvNoRefiARM"
BIZ_PreliminaryConditions_VerifyAllConditionStatus "E2E_ConvNoRefiARM"
