...
'@ TestCase:  PTAC-1360  - CONVNOCASHREFIARM - Processing 7- Order Appraisal
'@ Test Automation JIRA Task:  PTAC-1780 E2E_1ConvNoRefiARM_Processing
'@ TestData: Global_Data, Website, E2E_ConvNoRefiARM_Appraisal
'@ Pre-conditions: 
'@ Description: 
'@ TestSteps:
   'Step1:
   ...
   '3 Fill appointment scheduled, appointment completed, order completed as todays date and appraised value 200,000 and appraisal fee 100 click save next to these buttons 
      'and click send messages or documents button.
   ...
   '5 check the checkbox next to certification and click send.
   '6 Click on current orders.
   '7 under services tab click on appraisal icon.
   '8 Click on import under order update.
   '9 Click on import.
   '10 Click ok.
   '11 In e-folder you can see the attachment for the appraisal with received status.
'@ ExpectedResult:
...
'***************************************************************************************************
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-1360","TestCase Name : CONVNOCASHREFIARM - Processing 7- Order Appraisal", Null

BIZ_Tools_SendOrderAppraisal "E2E_ConvNoRefiARM"
BIZ_Services_LoginAppraisalCenter "E2E_ConvNoRefiARM_Appraisal"  
BIZ_Services_ProcessAppraisalCenterAndSendDocument "E2E_ConvNoRefiARM"
