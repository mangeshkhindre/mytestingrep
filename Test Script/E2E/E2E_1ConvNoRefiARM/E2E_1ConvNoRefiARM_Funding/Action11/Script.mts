...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-1467","Complete the funding worksheet", Null

Dim strLoanNumber, objData, objGridFees, intGridRowsCount, intGridRow
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS9Complete_ConvNoRefiARM","Funding"
'Go to Tools->Funding Worksheet
BIZ_Tools_Open "Funding worksheet"

'Sets the function details 
BIZ_FundingWorksheet_SetFundingClosing "E2E_ConvNoRefiARM"
BIZ_FundingWorksheet_SetFundingSource "E2E_ConvNoRefiARM"
BIZ_FundingWorksheet_SetWireInformation "E2E_ConvNoRefiARM"

'Select all checkboxes at the end of Funding Worksheet
BIZ_FundingWorksheet_CheckFeeLines()

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_ConvNoRefiARM_Funding")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Funded")) Then 
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS10Complete_ConvNoRefiARM"
End If
