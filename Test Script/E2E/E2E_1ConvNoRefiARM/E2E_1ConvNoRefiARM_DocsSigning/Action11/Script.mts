...
'@ TestCase:  PTAC-1432  CONVNOCASHREFIARM - Docs Signing 1 - Receive Closing conditions
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-1432","CONVNOCASHREFIARM - Docs Signing 1 - Receive Closing conditions", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS9Complete_ConvNoRefiARM","Docs Signing"

Set objDataProcessing = FRM_DS_GetTestData("Loans", "Milestone", "E2E_ConvNoRefiARM_DocsSigning")

BIZ_Loan_AcceptFiles "Docs Signing", FRM_DS_GetValue(objDataProcessing, "NextUser")
BIZ_Documents_SetDocumentsStatus "E2E_ConvNoRefiARM_AllDocument"
