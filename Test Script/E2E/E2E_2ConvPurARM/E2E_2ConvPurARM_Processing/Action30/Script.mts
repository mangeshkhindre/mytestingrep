...
'@ TestCase: PTAC-762 - Order Title
'@ Test Automation JIRA Task: PTAC-990 E2E_2CONVPURARM_Processing
'@ TestData: 
	'1 Services,TitleNClosing,E2E_CONVPURARM
	'2 Global_Data,Website,E2E_CONVPURARM_TitleCenter
	'3 Services,TitleService,E2E_CONVPURARM
	'4 eFolder_Tab,AttachDocuments,E2E_CONVPURARM
	'5 Loans,MilestoneDocument,E2E_CONVPURARM_Processing
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   'Step1 Test Steps:
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-762","Test Case Name - PTAC-762 - - Order Title", Null

Dim objData
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_CONVPURARM_Processing")

BIZ_Services_SetOrderTitleAndClosing "E2E_CONVPURARM"
GUI_Dialog_Encompass_OK("")
GUI_Browser_CloseAllBrowsers g_DefaultBrowser
BIZ_Services_LoginTitleCenter "E2E_CONVPURARM_TitleCenter"
BIZ_Services_ProcessTitleCenterDetailsAndSendDocument "E2E_CONVPURARM"
GUI_Dialog_Encompass_OKX 25, ""
BIZ_Services_ImportTitleDocument ""
BIZ_Nav_eFoler_Open()
BIZ_Documents_AttachDocuments "E2E_CONVPURARM"
...
BIZ_Document_AttachMandatoryDocuments "Processing", "E2E_CONVPURARM_Processing"
