...
'@ TestCase : PTAC-3223 FHAPURCHASEFIX- Post Closing 3 - Order Encompass Compliance services
...
'@ ExpectedResult: 
	...
	'3 Order should be generated with status completed and result should be warning or pass. 
        'you can click on the document and it will open the report.
	'4 Milestone should be finished.
'***************************************************************************************************

FRM_Logger_ReportStepEvent "Start Test Case : PTAC-3223","FHAPURCHASEFIX- Post Closing 3 - Order Encompass Compliance services", Null

Dim objData

BIZ_TQLServices_SubmitOrder "Compliance Service","" 
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURCASHFIX_PostClosing")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Post Closing finished")) Then 
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS11Complete_FHAPURCASHFIX"
End If
