...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-3219","FHAPURCHASEFIX- Docs Signing 1 - Receive Closing conditions", Null
...
'Search for loans with MS9Complete as borrowers middle name
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS9Complete_FHAPURCASHFIX","Docs Signing"
Set objDataProcessing = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURCASHFIX_DocsSigning")

BIZ_Loan_AcceptFiles "Docs Signing", FRM_DS_GetValue(objDataProcessing, "NextUser")
BIZ_Documents_SetDocumentsStatus "E2E_FHAPURCASHFIX_AllDocument"
