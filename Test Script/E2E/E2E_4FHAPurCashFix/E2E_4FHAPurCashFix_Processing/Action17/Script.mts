...
'@ TestCase : PTAC-3168 FHAPURCHASEFIX - Processing 7- Order Appraisal
...
'@ TestSteps:
   ...
   'Step2 test Steps:
	...
	'03 Fill appointment scheduled, appointment completed, order completed as todays date and appraised value 200,000 and appraisal fee 100 
	    'click save next to these buttons and click send messages or documents button.
	'04 Under appraisal documents click browse for attached appraisal pdf select any pdf and slect appraiser as appraiser clark from the dropdown
	    'check the checkbox next to certification and click send.
	'05 Click on current orders.
	'06 under services tab click on appraisal icon.
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-3168","FHAPURCHASEFIX - Processing 7- Order Appraisal", Null

BIZ_Tools_SendOrderAppraisal "E2E_FHAPURCASHFIX"
BIZ_Services_LoginAppraisalCenter "E2E_FHAPURCASHFIX_Appraisal"  
BIZ_Services_ProcessAppraisalCenterAndSendDocument "E2E_FHAPURCASHFIX"
