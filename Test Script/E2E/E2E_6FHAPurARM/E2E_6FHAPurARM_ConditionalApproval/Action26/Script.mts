...
'@ TestCase:  PTAC-2042 Conditional Approval 1 - Complete Underwriter Summary
'@ Test Automation JIRA Task: PTAC-2123 E2E_6FHAPURARM_ConditionalApproval
'@ TestData: 
	'1 Tools_UnderwriterSummary, UWP1_SetUnderWriterDetails, E2E_FHAPURARM
	'2 Tools_UnderwriterSummary, UWP2_SetHeaderData, E2E_FHAPURARM
	'3 Global_Data, Login, E2E_janet
	'4 Loans, LoanTemplate, E2E_LoanOfficer
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
	'1 Login to encompass as Janet..
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2042","Test Case Name - Conditional Approval 1 - Complete Underwriter Summary ", Null
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS5Complete_FHAPURARM","Cond. Approval"
...
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURARM_ConditionalApproval")
...
BIZ_UnderwriterSummary_SetUnderWriterDetails "E2E_FHAPURARM"
BIZ_UnderwriterSummary_SetAppraisalAUSDetails "E2E_FHAPURARM"
