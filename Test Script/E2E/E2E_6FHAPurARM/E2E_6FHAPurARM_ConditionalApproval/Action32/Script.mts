...
'@ TestCase:  PTAC-2045 Conditional Approval 4 - Finish Milestone
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2045","Test Case Name - Conditional Approval 4 - Finish Milestone", Null

Dim objData

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURARM_ConditionalApproval")
BIZ_Document_AttachMandatoryDocuments "Cond. Approval", "E2E_FHAPURARM_ConditionalApproval"
...
If BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Cond. Approval finished") Then
   ...
   GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS6Complete_FHAPURARM"    
End If
