...
'@ TestCase : PTAC-2116 Doc Preparation 3 - Fill the closing Vendor information form
'@ Test Automation JIRA Task: PTAC-2126 E2E_6FHAPURARM_DocumentPrepartion
'@ TestData: 
    '1 Tools_FileContacts, CopySettlementService, E2E_FHAPURARM1
    '2 Tools_FileContacts, CopySettlementService, E2E_FHAPURARM2
    '3 Tools_FileContacts, CopySettlementService, E2E_FHAPURARM3
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
...
'@ ExpectedResult: 
	...
	'10 Pop up will close.
	'11 All data should be populated.
'***************************************************************************************************
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-2116","Doc Preparation 3 - Fill the closing Vendor information form", Null

BIZ_FileContacts_CopyBusinessContactsSettlementService "E2E_FHAPURARM1"

BIZ_FileContacts_CopyBusinessContactsSettlementService "E2E_FHAPURARM2"

BIZ_FileContacts_CopyBusinessContactsSettlementService "E2E_FHAPURARM3"
