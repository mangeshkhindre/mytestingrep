...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2131","Funding 1-Complete the funding worksheet", Null

Dim objData, intGridRowsCount, objGridFees, intGridRow
...
BIZ_Loan_OpenLoanByBorrNameAndNextExpectedMilestone "MS9Complete_FHAPURARM","Funding"

'Go to Tools->Funding Worksheet
BIZ_Tools_Open "Funding worksheet"

'Sets the function details 
BIZ_FundingWorksheet_SetFundingClosing "E2E_FHAPURARM"
BIZ_FundingWorksheet_SetFundingSource "E2E_FHAPURARM"
BIZ_FundingWorksheet_SetWireInformation "E2E_FHAPURARM"

Set objGridFees  = SwfWindow("swfname:=MainForm").SwfWindow("swfname:=MainScreen").SwfWindow("swfname:=LoanPage").SwfObject("swfname:=gridFees2015")
intGridRowsCount = GUI_List_GetNumberofRows(objGridFees)

For intGridRow  = 0 To intGridRowsCount-1 Step 1
	GUI_List_SelectCheckBoxinCell objGridFees, 0, intGridRow
Next

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURARM_Funding")
...
If BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Funded") Then
   ...
   GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS11Complete_FHAPURARM"    
End If
