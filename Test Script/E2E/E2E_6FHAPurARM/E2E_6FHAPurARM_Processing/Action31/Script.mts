...
'@ TestCase : PTAC- 1916 - Processing 8- Order Title
'@ Test Automation JIRA Task:  PTAC-2121 E2E_6FHAPURARM_Processing
'@ TestData: 
    '1 Services, TitleNClosing, E2E_FHAPURARM
    '2 Global_Data, Website, E2E_FHAPURARM_TitleCenter
    '3 Services, TitleService, E2E_FHAPURARM
    '4 eFolder_Tab, AttachDocuments, E2E_FHAPURARM
'@ Pre-conditions: 
'@ Description:  
'@ TestSteps:
   '1 1 click services and click order title.
	 '2 click continue.
     ...
     '5 click ok.
   '2 1 Now go to tile center link in test data column and login with the credentials provided.
   ...
   '3'1 Click log tab and click on processing.
...
'@ ExpectedResult: 
   '1 1 preferred title welcome window opened.
   ...
   '3 1 Processing worksheet will open.
...
FRM_Logger_ReportStepEvent "Start Test Case PTAC-1916","Test Case Name :Processing 8- Order Title", Null

Dim objData,blnDocumentStatus
Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_FHAPURARM_Processing")

BIZ_Services_SetOrderTitleAndClosing "E2E_FHAPURARM"
GUI_Dialog_Encompass_OKX 40, ""
GUI_Browser_CloseAllBrowsers g_DefaultBrowser

BIZ_Services_LoginTitleCenter "E2E_FHAPURARM_TitleCenter"
BIZ_Services_ProcessTitleCenterDetailsAndSendDocument "E2E_FHAPURARM"
GUI_Dialog_Encompass_OKX 40, ""
'BIZ_Services_ImportTitleDocument ""

BIZ_Nav_eFoler_Open()
BIZ_Documents_AttachDocuments "E2E_FHAPURARM"
...
BIZ_Document_AttachMandatoryDocuments "Processing","E2E_FHAPURARM_Processing"
...
If BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Processing") Then
   ...
   GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS4Complete_FHAPURARM"    
End If
