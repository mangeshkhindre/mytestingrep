...
'@ TestCase: PTAC-2425 Settings Reports - UserGroups - Generate  and validate User Group sheet "Role List View" - Admin login for existing persona, user account, group and role.
...
FRM_Logger_ReportStepEvent "Start Test Case: PTAC-2425", "Settings Reports - UserGroups - Generate  and validate User Group sheet 'Role List View' - Admin login for existing persona, user account, group and role.", Null
