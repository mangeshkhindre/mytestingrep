...
'@ TestCase : PTAC-3489 CONVCASHOUTREFIFIX Post Closing 3 - Order Encompass Compliance services
...
FRM_Logger_ReportStepEvent "Start Test Case : PTAC-3489","CONVCASHOUTREFIFIX Post Closing 3 - Order Encompass Compliance services", Null

Dim objData
BIZ_TQLServices_SubmitOrder "Compliance Service","" 

Set objData = FRM_DS_GetTestData("Loans", "Milestone", "E2E_CONVCASHOUTREFIFIX_PostClosing")
...
If (BIZ_Loan_VerifyIfMilestoneIsCompletedForLoan("Post Closing finished")) Then 
	...
	GUI_WebEdit_Set SwfWindow("swfname:=MainForm").Page("title:=.*","index:=0").WebEdit("html id:=TextBox10"), "MS11Complete_CONVCASHOUTREFIFIX"
End If
