'@**************************************************************************************************
 '@ TestStory: CTA-277 HMDA 
 '@ TestCase:    
    '1 CTA-277 HMDA -18.2- E2E-HMDA - Verify HMDA.X15 Rate spread field
 '@ Test Automation JIRA Task: CTA-290 18.2- E2E-HMDA - Verify HMDA.X15 Rate spread field
 ...
 '@ TestSteps:
    'CTA-134 Teststeps
     ...
     '05 Click on Additional Services--> Compliance Review Setup. Click on 'Change Setup.
     '06 Set Report feild:Premium
...
BIZ_HMDA_AddNewHMDAProfile "CTA-277"

'====== Navigate to Complinace Revie Setup page ======
BIZ_Nav_OpenMenuItem "Encompass;Settings..."
BIZ_Nav_HierarchyTree "Additional Services","Compliance Review Setup"

'====== Set the Feilds on Compliance Review Setup Page ======

Set_compliance_Review_setup("CTA-277") 

'====== Logout of the Encompass ======
BIZ_Login_UserLogout()

'====== Login to the Encompass as admin ======
BIZ_Login_UserLogin "admin_core2p"

'====== Navigate to pipeline and create a new loan in Automation folder ======
...
'======= Enter Loan Data =================================================
BIZ_BorrowerSummaryOrigination_SetBorrower "CTA277"
BIZ_BorrowerSummaryOrigination_SetProperty "CTA277"
BIZ_BorrowerSummaryOrigination_SetTransactionDetails "CTA277"

'======= Navigate to RegZ CD page and enter the data =================================================

BIZ_Forms_Open "RegZ - CD"

BIZ_RegZ_CD_SetData "CTA277"

'======== Navigate to HMDA Form ===================================================

BIZ_Forms_Open "HMDA Information"

wait g_ShortWaitSmall

BIZ_HMDAPageObj.WebList("html id:=hmdaprofilename").select "CTA277"
BIZ_HMDAPageObj.WebList("html id:=DropdownBox3").select "1. Loan originated"

'======= Click on Tools and Check Service ==================
...
wait g_LongWaitMedium+g_LongWaitMedium
...
FRM_Logger_ReportInfoEvent "Verify the Rate Spread","Verify the Rate Spread on HMDA Page", Null 

FRM_VerifyEqual GUI_Object_GetPropertyValue (BIZ_HMDAPageObj.WebEdit("html id:=TextBox11"),"value"),"1.68","Verify Rate Spread Value","Rate Spread Value Check"
...
'If BIZ_HMDAPageObj.WebEdit("html id:=TextBox24").Exist(2) Then
'	GUI_Object_ValidateProperty BIZ_HMDAPageObj.WebEdit("html id:=TextBox24"),"value","NA","Loan Term HMDA.X83"
'ElseIf BIZ_HMDAPageObj.WebEdit("html id:=l_HMDAX83").Exist(2) Then	
'	GUI_Object_ValidateProperty BIZ_HMDAPageObj.WebEdit("html id:=l_HMDAX83"),"value","NA","Loan Term HMDA.X83"
'End If
'
