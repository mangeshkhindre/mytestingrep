...
'@ TestCase:  Verify access rights under "Home" tab of Encompass Settings for Loan Processor persona
...
'**********************************************************************************************************
'Pipeline Tab
'Select Loan Processor persona in Encompass settings
BIZ_Settings_Personas_SelectPersona "Loan Processor"

FRM_Logger_ReportStepEvent "Start Test Case: PTAC-910",_
"Verify access rights under 'Pipeline' tab of Encompass Settings for Loan Officer persona and re-enforcement validations",Null
...
If lcase(strExecutionFlag)= "yes" Then
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1281",_
"Verify access rights under 'Pipeline' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	Set objData = FRM_DS_GetTestData("Setttings_CompanyUserSetup","Verify_PersonaAccessRights","1679_LoanProcessor")
	...
	"Access to Pipeline/Loan Tab"),"Personas->Loan Processor->'Pipeline' Tab","'Access to Pipeline/Loan Tab' is checked"
	
	'Validation for "Pipeline Views" section
	boolDefaultLpView=GUI_List_ClickRow(objSettings.SwfObject("swfname:=gvPipelineViews"),Null,"Name","Default LP View",True,False,false,"Single")
	...
	FRM_VerifyTrue (boolDefaultLpView OR boolDefaultView),"Personas->Loan Processor->'Pipeline' Tab","'Default LP View' is visible in Pipeline Views section"
	...
	"Personas->Loan Processor->'Pipeline' Tab","Default options are checked in 'Pipeline Tasks' section"
...
strExecutionFlag=FRM_DS_GetValue(objData, "ExecutionFlag")
If lcase(strExecutionFlag)= "yes" Then
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1283",_
"Verify access rights under 'Loan' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	FRM_VerifyTrue boolCheckedStatus,"Personas->Loan Processor->'Loan' Tab","Default options in 'Milestone/Workflow Management' section are checked"
	...
	"Personas->Loan Processor->'Loan' Tab","All options are selected under 'Itemization Fee Management' section"
	...
	"Personas->Loan Processor->'Loan' Tab","All options are checked under 'Print' section"
	...
	"Personas->Loan Processor->'Loan' Tab","Default options are checked under 'Other' section"
	...
	"Personas->Loan Processor->'Loan' Tab","Default options are checked under 'Closing Docs' section"
...
strExecutionFlag=FRM_DS_GetValue(objData, "ExecutionFlag")
If lcase(strExecutionFlag)= "yes" Then
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1285",_
"Verify access rights under 'Forms/Tools' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
...
'	Dim objSettings,boolInputFormsChecked
	...
	FRM_VerifyTrue boolInputFormsChecked,"Personas->Loan Processor->'Forms/Tools' Tab","Default options under 'Input Forms' section are checked"
	
	'GUI_SwfTreeView_SetCheckBoxItemStates2 objSettings.SwfWindow("swfname:=PersonaSettingsMainForm").SwfWindow("swfname:=ToolsPage").SwfObject("swfname:=gcTreeView").SwfTreeView("swfname:=treeViewTabs"),_
	...
	If lcase(strExecutionFlag)= "yes" Then
		...
		FRM_Logger_ReportStepEvent "Start Test Case: PTAC-947",_
		"Verify access rights under 'eFolder' tab of Encompass Settings for Loan Officer persona and re-enforcement validations",Null
		...
		"Personas->Loan Officer->'eFolder' Tab","'Access to Document Tab' is checked"
		...
		"Personas->Loan Officer->'eFolder' Tab","All options under 'General' section are in checked state"
		...
		"Personas->Loan Officer->'eFolder' Tab","All options under 'Unprotected Documents' section are in checked state"
		
		
		GUI_SwfTreeView_SetCheckBoxItemStates objeFolder.SwfTreeView("swfname path:=treeViewTabs;gcTreeView;FeaturesPage;pnlConditions;pnlBottom.*"),"All",True
		'Validation for "Conditions" section
		FRM_VerifyTrue GUI_SwfTreeView_ValidateCheckBoxes(objeFolder.SwfTreeView("swfname path:=treeViewTabs;gcTreeView;FeaturesPage;pnlConditions;pnlBottom.*"),"All"),_
		"Personas->Loan Officer->'eFolder' Tab","All options under 'Conditions' section are in checked state"
		...
		"Personas->Loan Officer->'eFolder' Tab","All options under 'Unassigned Files' section are in checked state"
		...
		"Personas->Loan Officer->'eFolder' Tab","All options under 'Protected Documents' section are in checked state"
...
strExecutionFlag=FRM_DS_GetValue(objData, "ExecutionFlag")
If lcase(strExecutionFlag)= "yes" Then
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1287",_
"Verify access rights under 'Trades/Contacts/Dashboard/Reports' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null

	'Dim boolContactsChecked, boolChecked,objSettings,objContactsPage
	...
	"Personas->Loan Processor->'Trades/Contacts/Dashboard/Reports' Tab","'Access to Trades Tab' is in unchecked state"
	
	'Validatin for "Contacts" section
	boolContactsChecked=GUI_SwfTreeView_ValidateCheckBoxes(objContactsPage.SwfTreeView("swfname path:=treeViewTabs;gcTreeView;ContactsMgrPage;panelContactPage;pnlExLeft.*"),_
	"0;1;2;3;5;10;11;13;14;15;16;17;18;19;23;24;25;26;27")
	...
	If (Instr(1,strContactsChecked,"20;21;22",0))>0 Then
		 boolChecked =True
	Else 
		boolChecked = False
	End If
	
	FRM_VerifyTrue (boolContactsChecked and boolChecked), "Personas->Loan Opener->'Trades/Contacts/Dashboard/Reports' Tab",_
	...
	"Personas->Loan Processor->'Trades/Contacts/Dashboard/Reports' Tab","Default options are in checked state under 'Dashboard' section"
	...
	"Personas->Loan Processor->'Trades/Contacts/Dashboard/Reports' Tab","No options are in checked state under 'Reports' section"
...
strExecutionFlag=FRM_DS_GetValue(objData, "ExecutionFlag")
If lcase(strExecutionFlag)= "yes" Then
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1290",_
"Verify access rights under 'Settings' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null

'	Dim objSettings,objSettingsPage 
	...
	FRM_VerifyTrue GUI_SwfTreeView_ValidateCheckboxesItemStates(objSettingsPage.SwfTreeView("swfname path:=treeViewTabs;gcTreeView;SettingsCompanyPage;pnlExCompanySettings.*"),FRM_DS_GetValue(objData,"Settings_CompanySettings"),"Yes"),_
	"Personas->Loan Processor->'Settings' Tab","Default options are in checked state under 'Company Settings' section"
	...
	"Personas->Loan Processor->'Settings' Tab","No options are in checked state under 'Other' section"
	...
	"Personas->Loan Processor->'Settings' Tab","Default options are in checked state under 'Personal Settings' section"
...
'Create user "loanprocessor" with Loan Processor persona if not already existing
BIZ_OrganizationUsers_CreateUser "ptac1679_LoanProcessor"

BIZ_Login_UserLogout()

'Login as "loanprocessor" user
BIZ_Login_UserLogin "1679_LoanProcessor"
...
"Verify access rights under 'Pipeline' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	'Right click on first loan
	GUI_List_ClickOnCellData SwfWindow("swfname:=MainForm").SwfObject("swfname:=gvLoans"),0,2,True,True,False,""
	
	GUI_Object_WaitTillVisibleX SwfWindow("swfname:=MainForm").SwfToolBar("swfname:=mnuLoans"),15
	
	'Verify "Export to Excel" option not available 
	boolItemExist = Instr(1,SwfWindow("swfname:=MainForm").SwfToolBar("swfname:=mnuLoans").GetVisibleText(),"Export to Excel",0)>0
	
	FRM_VerifyFalse boolItemExist,"Pipeline Tab Re-Enforcement","'Export to Excel' option is not displayed for user 'loanprocessor'"
End If
...
"Verify access rights under 'Loan' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	"'Print' button is displayed under 'Loans' tab in a loan for user 'loanprocessor'"
...
"Verify access rights under 'Forms/Tools' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	'Closing conditions form validation
	FRM_VerifyFalse GUI_List_VerifyItemExists(objMainView.SwfList("swfname:=emFormMenuBox"),"Closing Conditions"),_
	"Verify Closing Conditions", "'Closing Conditions' form should not be displayed under Forms tab for user 'loanprocessor'"
	
	'click on Tools tab
	GUI_List_Select SwfWindow("swfname:=MainForm").SwfTab("swfname:=toolsFormsTabControl"),"Tools"
	
	'Validation for Profit Management tool
	FRM_VerifyFalse GUI_List_VerifyItemExists(objMainView.SwfList("swfname:=emToolMenuBox"),"Profit Management"),_
	"Verify Profit Management","'Profit Management' tool should not be displayed under Tools tab for user 'loanprocessor'"
...
If lcase(strExecutionFlag)= "yes" Then
	...
	FRM_Logger_ReportStepEvent "Start Test Case: PTAC-1286",_
"Verify access rights under 'eFolder' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
...
"Verify access rights under 'Trades/Contacts/Dashboard/Reports' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	Dim boolExportExcelExists, boolPrintExists
	
	BIZ_Nav_SelectContactsTab()
	
	'if borrower contacts is not visible, by overlapped contact details pane
	If Not GUI_Object_IsExistX(SwfWindow("swfname:=MainForm").SwfObject("swfname:=gvContactList"),5) Then
	    GUI_SwfObject_Click SwfWindow("swfname:=MainForm").SwfObject("swfname:=collapsibleSplitter1")
	End If
	
	'right click on first borrower contact
	GUI_List_ClickOnCellData SwfWindow("swfname:=MainForm").SwfWindow("swfname:=BorrowerListForm")._
	SwfObject("swfname:=gvContactList"),0,2,True,True,False,""
	
	GUI_Object_WaitTillExistX SwfWindow("swfname:=MainForm").SwfToolBar("swfname:=gvMenuStrip"),10
	
	'Verify Export to Excel and Print Details
	boolExportExcelExists =SwfWindow("swfname:=MainForm").SwfToolBar("swfname:=gvMenuStrip").ItemExists("Export to Excel")
	boolPrintExists = SwfWindow("swfname:=MainForm").SwfToolBar("swfname:=gvMenuStrip").ItemExists("Print Details")
	
	'Validate if 'Export to Excel' option is not visible
	FRM_VerifyFalse boolExportExcelExists,"'Trades/Contacts' Tab Re-enforcement validation",_
	"'Export to Excel' option is not displayed in Borrower Contacts for user 'loanprocessor'" 
	
	'Validate if 'Print Details' option is not visible
	FRM_VerifyFalse boolPrintExists,"'Trades/Contacts' Tab Re-enforcement validation",_
	"'Print Details' option is not displayed in Borrower Contacts for user 'loanprocessor'" 
End If
...
"Verify access rights under 'Settings' tab of Encompass Settings for Loan Processor persona and re-enforcement validations",Null
	...
	'Navigate to Settings > Tables and Fees
	BIZ_Settings_ExpandTreeView "Tables and Fees"
	
	Set objSetupContainer=SwfWindow("swfname:=MainForm").SwfWindow("swfname:=SetUpContainer").SwfTreeView("swfname:=treeView")
	
	'Validate options under Settings -> Tables and Fees
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"Escrow"),"Settings -> Tables and Fees",_
	"'Escrow' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"Title"),"Settings -> Tables and Fees",_
	"'Title' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"HELOC Table"),"Settings -> Tables and Fees",_
	"'HELOC Table' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"MI Tables"),"Settings -> Tables and Fees",_
	"'MI Tables' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"FHA County Limits"),"Settings -> Tables and Fees",_
	"'FHA County Limits' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"City Tax"),"Settings -> Tables and Fees",_
	"'City Tax' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"State Tax"),"Settings -> Tables and Fees",_
	"'State Tax' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"User Defined Fee"),_
	"Settings -> Tables and Fees","'User Defined Fee' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"Itemization Fee Management"),"Settings -> Tables and Fees",_
	"'Itemization Fee Management' option is displayed"
	
	FRM_VerifyTrue GUI_List_VerifyItemExists(objSetupContainer,"LO Compensation"),"Settings -> Tables and Fees",_
	"'LO Compensation' option is displayed"
