...
strRowID = "E2E_HELOC_NewFinancingNotLinked"
FRM_Logger_ReportStepEvent "Start test case","Validation of CLTV, HCLTV for new financing not Linked amounts",Null
...
'===== Enter data in VOL section =======
BIZ_VOL_SetVOLData strRowID

BIZ_BorrowerSummaryOrigination_VerifySubFinancing strRowID
BIZ_ValidtSubOrdinatMrtgagLneAmt strRowID
